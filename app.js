...
if(!codigo || !nombre || !cantidad || !costo){
    ...
    let agregado= inventario.agregar(producto);
    if(agregado === null){
      document.getElementById('info').innerHTML= `<p>El código de este producto ya existe</p>`;
    } else{
...
if(eliminar === null){
  ...
  document.getElementById('info').innerHTML= `<p>El producto ${eliminar.obtenerNombre()} se eliminó correctamente</p>`;
}
})